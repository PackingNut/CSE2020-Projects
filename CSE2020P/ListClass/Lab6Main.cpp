...
/**
 * main file for our List class data structure 
 * 
 * Name: Ryan Calderon
 * file: Lab6Main.cpp
 * 
 * This program will create a list of randomly generated numbers and then
 * will search the given numbers for the largest sum of sequenced numbers
 * the sequence will then be returned and filled in with zeros.
 * 
*/
